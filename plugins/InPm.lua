...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to <b>TeleRock</b> !\n\nTo get a list of TeleRock groups use /chats or /chatlist for a document list of chats.\n\nTo get a new TeleRock group\n\n\nOur <b>Support</b> :\nhttps://telegram.me/joinchat/D_T8Kj9JhU8jrRQo_GxmrQ"
     	return text
    end
